...
class TestFurnitureArrangement(unittest.TestCase):
    ...
    def test_double_free_space_algorithm(self):
        self.assertEqual(
            self.calculator.free_space_algorithm(
                [
                    {
                        "south_east": {"x": 2, "y": 0},
                        "south_west": {"x": 0, "y": 0},
    ...
    def test_middle_of_the_distance_on_the_wall(self):
        self.assertEqual(
            self.calculator.middle_of_the_distance_on_the_wall(
                {
                    'left_corner': {'x': 0, 'y': 4},
                    'right_corner': {'x': 10, 'y': 4},
                },
                {
                    "first_wall": 4,
                    "second_wall": 10,
    ...
    def test_corner_markings_first_wall(self):
        self.assertEqual(
            self.calculator.corner_markings(
                {"length": 4, "width": 6}, {"x": 3, "y": 4}, 1
            ),
            {
                "north_west": {"x": 3, "y": 1},
                "north_east": {"x": 3, "y": 7},
