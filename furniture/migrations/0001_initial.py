        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=128, unique=True, verbose_name="Наименование мебели"
                    ),
                ),
                (
                    "name_english",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        validators=[furniture.validators.minimum_len_width_validator],
                ...
                (
                    "power_socket_type",
                    models.CharField(max_length=128, verbose_name="Тип электроточки"),
                ),
                (
                    "first_power_socket_height",
                    models.IntegerField(
                        default=0, verbose_name="Высота первой электроточки"
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        verbose_name="Расположение электроточки относительно середины ширины объекта",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=128, verbose_name="Название планировки"
                    ),
                ),
                (
                    "created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=128, unique=True, verbose_name="Наименование комнаты"
                    ),
                ),
