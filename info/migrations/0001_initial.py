    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=256, unique=True, verbose_name="Возможные действия"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=256, unique=True, verbose_name="Наименование тарифа"
                    ),
                ),
                (
                    "name_english",
                    ...
                    models.PositiveSmallIntegerField(
                        validators=[
                            django.core.validators.MinValueValidator(
                                0, message="Тариф должен быть больше 0 руб в мес"
                            )
                        ],
                ...
                (
                    ...
                    models.DurationField(
                        choices=[
                            (datetime.timedelta(days=30), "месяц"),
                            (datetime.timedelta(days=90), "3 месяца"),
                            (datetime.timedelta(days=180), "6 месяцев"),
                            (datetime.timedelta(days=270), "9 месяцев"),
                            (datetime.timedelta(days=365), "год"),
                        ],
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="tariff",
                        through="info.PossibleActionsTariff",
                        to="info.possibleactions",
                        verbose_name="Действия",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Тариф приобретен"
                    ),
                ),
                (
                    "tariff",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("action", "tariff"), name="double_actions"
            ),
        ),
    ]
