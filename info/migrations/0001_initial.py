    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_english', models.SlugField(unique=True, verbose_name='Наименование тарифа на английском языке')),
                ...
                ('project_limit', models.PositiveIntegerField(default=0, verbose_name='Количество планировок')),
                ('rooms_limit', models.PositiveIntegerField(default=0, verbose_name='Количество комнат')),
